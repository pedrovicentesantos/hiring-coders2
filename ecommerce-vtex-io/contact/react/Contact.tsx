...
const Contact: StorefrontFunctionComponent<ContactProps> = ({}) => {
  return (
    <Container>
      ...
      <a target="_blank" href={`https://api.whatsapp.com/send?phone=55229999999999&text=Ol%C3%A1%20do%20Hiring%20Coders`} className="item">
        <svg focusable="false" viewBox="0 0 24 24" aria-hidden="true">
